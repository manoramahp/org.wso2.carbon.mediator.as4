...
import org.wso2.carbon.mediator.as4.msg.impl.Description;
import org.wso2.carbon.mediator.as4.msg.impl.Error;

/**
 * AS4 error mapper which will map error codes with relevant severity and category.
 */
public class AS4ErrorMapper {
    ...
    public static void setErrorDetailsAndDesc(ErrorCode errorCode, Error error, String errorDescription) {
        ...
        error.setOrigin("ebMS"); //todo check
        switch (errorCode) {
            case EBMS0001:
